...
// Use the useUserAuth hook to get the user object and the login and logout functions
    ...
    return (
        <div>
            <h1 className="text-2xl font-bold mb-4">Assignment 9 - Welcome to the Shopping List App</h1>
            <p>
                {user ? 
                (<button 
            ...
            {user && <Link className="text-white font-bold py-2 px-4 rounded m-2 bg-slate-600" href="/week-9/shopping-list">Go to Shopping List</Link>} 
